...
class AdditionalCompositeFunctionTest {
    ...
    void testCompositeComplexChain() {
        ...
        CompositeFunction composite = new CompositeFunction(new CompositeFunction(func1, sqr), func2);
    ...
    void testCompositeWithConstantAndTabulated() {
        ...
        assertEquals(2.0, composite1.apply(0.0));
        assertEquals(2.0, composite1.apply(100.0));
    ...
    void testCompositeWithExtrapolation() {
        ...
        assertEquals(15.0, composite.apply(4.0));
    }
}